 ...
 */
@WebServlet("/share_deleteAction")
public class share_deleteAction extends HttpServlet {
		...
		// TODO Auto-generated method stub
			 ...
			 //dao의 getBoardDTO함수는 db연결해서 db의 값을 가져오는 거임.
		      if (!nickname.equals(dto.getNickname())) {
		         ...
		         int result = dao.deleteShare(sh_Num, section);
		         if (result == -1) {
		            script.println("<script>");
		            ...
		            script.println("location.href = 'share.jsp'");
		            script.println("</script>");
