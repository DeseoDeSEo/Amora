											...
											<h3></h3>
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="text" id="nickname" placeholder = " 닉네임 입력" class="form-control">				
													</div>
												</div>
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="text" id="nickname" placeholder = " 이름 입력" class="form-control">				
													</div>
												</div>
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="email" id="email" placeholder = " 전화번호" class="form-control">	
													</div>
												</div>
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="email" id="email" placeholder = " email 입력" class="form-control">	
													</div>
												</div>
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<div style="display: flex; justify-content: center; float: right; margin-right: 630px;">
														  <input type="button" onclick="findMyApart()" value="관리할 아파트 등록" class="form-control" style="width: 200px !important;">
														</div>
		   ...
		   function findMyApart() {
		     new daum.Postcode({
		            oncomplete: function(data) {
		                ...
		                // 커서를 상세주소 필드로 이동한다.
		                document.getElementById("adminjoin").focus();
		            }
		        }).open();
