									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
												...
												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" id = "adminjoin" class="btn btn-primary1 btn-block" value="일반회원가입하기">
													</div>
												</div>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" id = "adminjoin" class="btn btn-primary1 btn-block" value="관리자회원가입하기">
													</div>
												</div>
