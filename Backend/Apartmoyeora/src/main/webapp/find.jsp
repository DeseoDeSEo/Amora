						...
						<div class="board_wrap">
							...
							<div class="board_list_wrap">
								<div class="board_list">
									...
									<div>
									    <div class="category">찾아주세요</div>
										<div class="num">4</div>
										 <div class="title"><a href="secondhand.jsp">준영이를 찾아주세요</a></div>
								...
								<div class="bt_wrap">
									<a href="write.html" class="on">글쓰기</a> <a href="edit.html">수정</a>
								</div>
							</div>
						</div>
					</div>
