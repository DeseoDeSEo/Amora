					...
					<div class="topmargin">
						...
						<div style="margin-top: 10px;" class="board_wrap">
							...
							<div class="board_list_wrap">
											...
											<div
												...
												<div class="col mb-5">
													<div class="card h-100">
														...
														<img class="card-img-top"
															src="https://search4.kakaocdn.net/argon/229x0_80_wr/2hhYO3JnchR"
															alt="..." />
														<!-- Product details-->
														<div class="card-body p-4">
															<div class="text-center">
																<!-- Product name-->
																<h5 class="fw-bolder">유모차</h5>
															</div>
														</div>
														<!-- Product actions-->
														<div
												...
												<div class="col mb-5">
													<div class="card h-100">
														...
														<div class="card-body p-4">
															<div class="text-center">
																<!-- Product name-->
																<h5 class="fw-bolder">식탁</h5>
																<!-- Product reviews-->
																<div>
																	<a class="d-flex justify-content-center small text-warning mb-2">
												...
												<div class="col mb-5">
													<div class="card h-100">
														<!-- Sale badge-->
														<div class="badge bg-dark text-white position-absolute"
															style="top: 0.5rem; right: 0.5rem">초특가</div>
														<!-- Product image-->
														<img class="card-img-top"
															src="https://dummyimage.com/450x300/dee2e6/6c757d.jpg"
															alt="..." />
														...
														<div
															class="card-footer p-4 pt-0 border-top-0 bg-transparent">
															<div class="text-center">
																<a class="btn btn-outline-dark mt-auto" href="#">오늘
																	종료</a>
															</div>
														</div>
													</div>
								...
								<div class="bt_wrap">
									<a href="write.jsp" class="on">글쓰기</a> <a href="edit.jsp">수정</a>
								</div>
							</div>
						</div>
					</div>
