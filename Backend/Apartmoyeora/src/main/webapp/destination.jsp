									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
												...
												<div class="row form-group">
													<div class="col-md-12">
														<a href="userjoin.jsp"><input type="submit" id = "adminjoin" class="btn btn-primary1 btn-block" value="일반 회원가입"></a>
													</div>
												</div>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<a href="adminjoin.jsp"><input type="submit" id = "adminjoin" class="btn btn-primary1 btn-block" value="관리자 회원가입"></a>
													</div>
												</div>
