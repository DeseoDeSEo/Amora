										...
										if(session.getAttribute("info")!=null){
											...
											%>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<h1 for="activities" style="flloat: left; margin-left: 10px;">id : <%= id %></h1>
													</div>
												</div>
												
												
													
													<h1>닉네임 : <%= info.getNickname() %></h1>												
												...
												<div class="row form-group">
													<div class="col-md-12">
														<a href="updateusers.jsp"><input type="submit" class="btn btn-primary1 btn-block" value="회원정보수정"></a>
													</div>
												</div>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<a href="DropoutService"><input type="submit" class="btn btn-primary1 btn-block" value="탈퇴하기"></a>
													</div>
												</div>
