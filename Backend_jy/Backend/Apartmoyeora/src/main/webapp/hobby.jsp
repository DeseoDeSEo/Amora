						...
						<div class="board_wrap">
							...
							<div class="board_list_wrap">
								<div class="board_list">
									...
									<div>
									    <div class="category">취미생활</div>
										<div class="num">4</div>
										 <div class="title"><a href="secondhand.jsp">구슬 공예 원데이 클래스</a></div>
										<div class="writer">서보경</div>
									...
									<div>
									    <div class="category">취미생활</div>
										<div class="num">3</div>
										<div class="title"><a href="secondhand.jsp">러닝 뛸 사람 구해요</a></div>
										<div class="writer">김경민</div>
									...
									<div>
									    <div class="category">취미생활</div>
										<div class="num">2</div>
										<div class="title"><a href="secondhand.jsp">피자 만들기 클래스</a></div>
										<div class="writer">최종화</div>
									...
									<div>
									    <div class="category">취미생활</div>
										<div class="num">1</div>
										<div class="title"><a href="secondhand.jsp">요리 원데이 클래스</a></div>
										<div class="writer">이준영</div>
