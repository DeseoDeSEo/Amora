...
/**
 * Servlet implementation class con_purchase_del
 */
@WebServlet("/con_purchase_del")
public class con_purchase_del extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int cnt = dao.purchase_del(gb_Num, id);
				
		if(cnt==1) {
			System.out.println("공동구매 삭제 성공");
		}else {
			System.out.println("공동구매 삭제 실패");
		}
