   ...
   <div class="container">
      <div class="row">
         <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
            ...
            <tbody>
               ...
               <tr>
                ...
                <%--  <tr>
                  <td>사진</td>
                  <td colspan="2" style="min-height: 200px; text-align: left;"><%= dto.getSh_()"<br>") %></td>
               </tr> --%>
            </tbody>
         </table>
         ...
         %>
               ...
               <a onclick="return confirm('정말로 삭제하시겠습니까?')" href="sh_deleteAction?sh_Num=<%= sh_Num %>&section=<%= dto.getSection() %>" class="btn btn-primary">삭제</a>
