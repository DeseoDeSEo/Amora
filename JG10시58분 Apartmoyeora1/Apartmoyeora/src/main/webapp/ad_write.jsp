			...
			<div class="gtco-container">
				<div class="row">
					<div class="topmargin">
					 ...
					 <form action ="ad_writee" method="post" >
						<div class="board_wrap">
							...
							<div class="board_list_wrap">
								...
								<div class="board_list">
									<!-- <div style="float: left;">
										 <select id="category" name ="com_Category">
									...
									<textarea name="ad_Title" style="height: 40px; width: 840px; resize: none; overflow: hidden; text-align: left;" placeholder="제목입력"></textarea>
									<div>
									...
									<div>
									    <textarea name="ad_Content" rows="10" cols="65" style="width: 840px;" placeholder="관리자의 판단하에 비방글은 삭제 됩니다."></textarea>
									</div>
                            ...
                            <div style="position: relative; top: 30px; left: 350px;" class="bt_wrap">
                                <input style="background-color: #00000; border: 3px solid #7297F7;" name="write" type="submit" value="완료">
                                <a style="border: 3px solid #7297F7; color: black;" href="promotion.jsp">취소</a>
                            </div>
                    	</div>
				</form>
