...
<!-- 이종권 여기시작 -->
	...
	<div class="container">
		...
		<form method= "post" action="ntc_updateAction.jsp?no_num=<%=no_num %>">		
		  	...
		  	<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
		  		...
		  		<tbody>
		  			<tr>
		  				...
		  				<td><input type="text" class="form-control" placeholder="글 제목" name="bbsTitle" maxlength="50" value="<%=bbs.getNo_title()%>"></td>                            
		  			</tr>
		  			<tr>	
		  				<!-- textarea 태그는 장문의 글을작성할때 사용// style="height: 350px; 글높이 350px로 고정한다-->
		  				<td><textarea class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2048" style="height: 350px;"><%=bbs.getNo_content()%></textarea></td>
		  			</tr>		  	
		  		</tbody>
			...
			<!-- 글쓰기 버튼 -->
			<input type ="submit" class="btn btn-primary pull-right" value="글수정하기">		
