					...
					<div class="topmargin">
						...
						<div class="board_wrap">
							...
							<tr style="background-color: white;">
								<td><%=list_Search.get(i).getSection()%></td>
								<td><%=list_Search.get(i).getSh_Num()%></td>
								<td><a
									href="sh_view.jsp?sh_Num=<%=list_Search.get(i).getSh_Num()%>"><%=list_Search.get(i).getSh_title()%></a></td>
								<td><%=list_Search.get(i).getNickname()%></td>
								<td><%=list_Search.get(i).getSh_date().substring(0, 11) + list_Search.get(i).getSh_date().substring(11, 13) + ":"+ list_Search.get(i).getSh_date().substring(14, 16)%></td>
								<td><%=list_Search.get(i).getSh_views()%></td>
							</tr>
							<%
							}
							%>
