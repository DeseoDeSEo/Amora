					...
					<div class="topmargin">
						...
						<div class="board_wrap">
							<div class="board_title">
								<h1 style ="font-size:40px;"><b>나눔</b></h1>
								<!-- 헤더 아래 커뮤니티 크기 키움, 아래는 수평선 크기 임. -->
								<hr style="border: 2px solid #000">
								<p> 이웃끼리 서로 나누고 베푸는 아모라 아파트!</p>
							</div>
							<div class="board_list_wrap">
							<form action="ShareService" method="post" enctype = "multipart/form-data">
								<div class="board_list">
									<div style="float: left;">
										<select name=section id="category">
											<option name="secondhand" value="secondhand">중고거래</option>
											<option name="share" value="share">나눔</option>

										</select>
									</div>
									<div style="width: 30px; height: 7px;"></div>
									
									<textarea  style="height:40px; width: 840px; position: relative; top : 10px;" name="sh_title" rows="1" cols="65" placeholder=" 제목입력"></textarea>
								<textarea name="sh_price" rows="1" cols="65" placeholder=" 가격입력"></textarea>
								<div>
									<div style="width: 30px; height: 40px;"></div>
									<textarea name="sh_content" rows="10" cols="65"
						...
						<div class="bt_wrap">
							<a href="secondhand.jsp" class="on">완료</a> <a href="secondhand.jsp">취소</a>
						</div>
					</div>
				</div>
			</div>
