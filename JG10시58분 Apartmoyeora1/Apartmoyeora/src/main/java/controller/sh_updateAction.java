 ...
 */
@WebServlet("/sh_updateAction")
public class sh_updateAction extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (!info.getId().equals(dto.getId())) {
			...
			if (request.getParameter("sh_title") == null || request.getParameter("sh_content") == null
					...
					int result = dao.update(info, request.getParameter("sh_title"), request.getParameter("sh_content"),dto.getSection(), dto.getSh_Num());
					if (result == 0) {
						...
						script.println("location.href = 'sh_view.jsp?sh_Num="+sh_Num+"'");
